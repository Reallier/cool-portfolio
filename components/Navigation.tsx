...
export default function Navigation() {
  ...
  return (
    ...
    >
      <div
        className={clsx(
          "w-[80%] mx-auto px-6 flex items-center justify-between gap-6 transition-all duration-300",
      ...
      >
        <div className="flex items-center gap-8">
          <a
            ...
            className="group relative inline-flex items-center text-lg font-semibold tracking-tight text-text-main transition-colors hover:text-primary-blue"
          >
          ...
          <div className="hidden md:flex items-center gap-2 text-sm font-medium text-text-soft">
            {SECTIONS.map((item) => (
              <a
                key={item.href}
                href={item.href}
