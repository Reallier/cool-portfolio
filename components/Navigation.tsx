...
export default function Navigation() {
  ...
  return (
    <>
      ...
      >
        <div
          className="w-[90%] max-w-7xl mx-auto px-4 sm:px-6 flex items-center justify-between gap-4 sm:gap-6 py-1.5 transition-all duration-300"
        >
          <div className="flex items-center gap-4 sm:gap-8">
            <a
              href="#top"
              onClick={handleNavClick("#top", "top")}
              className="group relative inline-flex items-center text-sm sm:text-base font-semibold tracking-tight text-text-main transition-colors hover:text-primary-blue"
            >
            ...
            <div className="hidden md:flex items-center gap-2 text-xs font-medium text-text-soft">
              {SECTIONS.map((item) => (
                <a
                  key={item.href}
                  href={item.href}
          ...
          <div className="hidden md:flex items-center gap-4">
            ...
            >
              ...
              <span className="text-xs font-medium hidden lg:inline">Email</span>
            </a>
          </div>
      ...
      {isMobileMenuOpen && (
        <div className="fixed inset-0 z-40 md:hidden">
          ...
          <div className="fixed top-16 left-0 right-0 bg-surface border-b border-border-subtle shadow-lg">
            <div className="w-[90%] max-w-7xl mx-auto px-4 py-6 space-y-4">
